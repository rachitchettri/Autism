...
import AutismLogo from '../assets/autism.png'; // adjust path as needed
...
const Sidebar = () => {
  ...
  const menuItems = [
    { path: '/dashboard', name: 'Dashboard', icon: Home, description: 'Home & Overview' },
    { path: '/progress', name: 'Progress', icon: TrendingUp, description: 'Track Learning' },
    { path: '/users', name: 'Profiles', icon: User, description: 'Manage Kids' },
...
{/* Header */}
<div className="p-6 border-b border-green-600 flex justify-center items-center">
  <a href="/">
    <img
      src={AutismLogo}
      alt="Logo"
